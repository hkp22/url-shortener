<template>
    <div class="container container--centered">
        <router-link :to="{name:'home'}"><img src="../../../assets/logo.png" class="logo-home"/></router-link>
        <form action="#" class="urlform" @submit.prevent="shortenUrl" novalidate>
            <input type="url" placeholder="Enter url to short." class="urlform__input" v-model="formUrl">
        </form>
        ...
        <transition enter-active-class="animate animate--grow">
          <div class="result" v-if="shortened">
              <div class="result__details">
                  ...
                  <a :href="shortened.short_url" target="_blank" class="result__url" id="url">{{ shortened.short_url }}</a>
